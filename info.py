...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7945551029 6879937700').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/RahatMx")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002316472437'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+RzvwNgvyclk3ZDE1')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002316472437'))
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/ykQ.jpg')
START_IMG = environ.get('START_IMG', 'https://envs.sh/ykQ.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002316472437'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1001905670346'))
URL = environ.get('URL', '')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002316472437'))
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-4615441971'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002316472437')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002316472437'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002489923137'))
